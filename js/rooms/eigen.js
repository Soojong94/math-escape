...
export const eigen = {
  ...
  lesson: {
    ...
    sections: [
      ...
      {
        heading: "특성방정식 — 손으로 푸는 길",
        body: "고유값 λ 는 다음 2 차 방정식의 두 근. 시각으로 못 찾겠으면 이 식을 풀면 됨.",
        formula:
          "λ²  −  tr(A) · λ  +  det(A)  =  0\n" +
          "(여기서 tr = a + d,   det = ad − bc)",
      },
      {
        heading: "이 방의 계산",
        body: "A 의 tr 과 det 를 먼저 구하고 2 차 방정식으로 환원.",
        formula:
          "A  =  [[ 4  2 ]\n" +
          "       [ 1  3 ]]\n" +
          "\n" +
          ...
          "인수분해:    (λ − a)(λ − b)  =  0\n" +
          "             ↑       ↑\n" +
          "             합이 7, 곱이 10 인 두 수 a, b ?",
        note: "두 수를 찾아내면 그게 두 고유값. 둘 중 어느 쪽이든 정답으로 인정.",
      },
      {
        heading: "발견 / 대수 — 두 갈래",
        body: "1) 시각: θ 를 돌려가며 v 와 A·v 가 같은 직선 위에 놓이는 순간을 찾고 길이 비 읽기.\n" +
              "2) 대수: 위 특성방정식의 두 근을 구하기.\n" +
              "둘은 같은 답에 도달한다.",
      },
      {
        heading: "왜 중요한가",
