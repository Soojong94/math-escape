...
export const eigen = {
  ...
  lesson: {
    ...
    sections: [
      {
        heading: "방향을 보존하는 특별한 벡터",
        body: "행렬은 평면을 늘리고 비틀지만, *어떤 방향*의 벡터는 그 방향 그대로 길이만 변한다. " +
              "그 방향을 고유벡터, 변하는 길이의 배율을 고유값이라 부른다.",
        formula: "A · v  =  λ · v",
      },
      {
        heading: "왜 \"고유\" 인가",
        body: "행렬의 모든 작용 중에서 *방향을 보존하는* 방향은 행렬마다 정해져 있다. " +
              "이 \"각 행렬에 고유한 방향\" 이라는 점에서 \"고유\" 라는 이름.",
      },
      {
        heading: "이 방의 발견 절차",
