...
export const regression = {
  ...
  lesson: {
    ...
    sections: [
      {
        heading: "선형 회귀의 질문",
        body: "흩어진 점들 가운데, *하나의 직선* 으로 가장 잘 설명할 수 있을까? " +
              "어떤 직선이 \"가장 좋은\" 직선인가 — 그 기준이 곧 손실 함수.",
      },
      {
        heading: "MSE — Mean Squared Error",
        body: "각 데이터 점에서 직선까지의 *수직 거리* 를 잔차라 한다. " +
              "MSE 는 잔차들의 제곱을 평균낸 값. 직선이 점들에 가까울수록 MSE 가 작다.",
        note: "왜 제곱인가? 잔차 부호를 없애고, 큰 오차에 더 큰 벌점을 주기 위함.",
      },
      {
        heading: "최소제곱 직선",
        body: "MSE 를 가장 작게 만드는 m, b 의 조합이 \"최적 회귀선\". " +
              "MSE 가 0 이라는 것은 모든 점이 정확히 그 직선 위에 있다는 뜻 — 완벽한 선형 관계.",
      },
      {
        heading: "왜 중요한가",
