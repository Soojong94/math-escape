...
export const matrix = {
  ...
  lesson: {
    ...
    sections: [
      {
        heading: "선형 변환으로서의 행렬",
        body: "2×2 행렬 A 는 평면의 모든 점 (x, y) 를 새 좌표로 보낸다. " +
              "이 변환은 직선을 직선으로, 원점을 원점으로 보낸다. 격자가 *늘어나고 비틀린다*.",
      },
      {
        heading: "기저벡터의 행방",
        body: "A 의 첫 번째 열은 (1, 0) 이 어디로 가는지, 두 번째 열은 (0, 1) 이 어디로 가는지를 알려준다. " +
              "이 두 *도착 벡터* 가 새로운 평행사변형의 두 변이 된다.",
      },
      {
        heading: "행렬식 = 면적 배율",
        body: "행렬식은 *단위 정사각형이 얼마나 늘어났는가* 를 나타낸다. " +
              "변형 전 면적 1 → 변형 후 면적 |det A|. 음수면 평면이 뒤집혔다는 뜻.",
        note: "이 \"늘어남\" 의 양을 *시각으로* 또는 *격자점으로* 직접 세어볼 수 있다.",
      },
      {
        heading: "왜 중요한가",
