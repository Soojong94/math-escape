...
export const casino = {
  ...
  lesson: {
    ...
    sections: [
      ...
      {
        heading: "거듭제곱 mod 를 손으로 계산하는 법",
        body: "매 단계마다 직전 값에 g 를 곱하고 mod p 로 줄이기. 절대 큰 수를 그대로 들고 가지 말 것.",
        formula:
          "next  =  (prev · g)  mod p\n" +
          "예 : 5^4 mod 23 \n" +
          "  5^1 = 5\n" +
      ...
      {
        heading: "이 방의 풀이 — 5^x mod 23 표",
        body: "한 줄씩 곱하고 mod 23 으로 줄이며 목표 18 이 나오는 줄을 찾는다.",
        formula:
          "x   5^x         mod 23\n" +
          "──  ──────────  ──────\n" +
          " 1  5             5\n" +
          ...
          "11  9 · 5  = 45   22\n" +
          "12  22· 5  = 110  ?",
        note: "마지막 줄의 mod 23 만 직접 계산 (110 − 4·23 = ?) — 그 값이 18 이라면 그때의 x 가 정답.",
      },
      {
        heading: "왜 역방향이 어려운가",
        body: "큰 p 에서는 알려진 효율적 알고리즘이 없다. " +
              "g^x mod p 계산은 O(log x) 로 빠르지만 거꾸로 x 를 찾는 빠른 방법은 미해결. " +
              "Diffie-Hellman, ElGamal, ECDSA, 비트코인 서명 — 모두 이 비대칭이 토대.",
      },
    ],
  },
