...
export const recursion = {
  ...
  lesson: {
    ...
    sections: [
      ...
      {
        heading: "수열의 발견",
        body: "n = 1 부터 차례로 직접 세어보면 어떤 수열이 나타나는가. " +
              "*각 항이 앞 두 항의 합* 이라는 패턴이 보일 것이다.",
      },
      {
        heading: "이 방의 계산 — 점화식 채우기",
        body: "f(n) = n 칸 계단을 오르는 서로 다른 경로 수. f(1) = 1, f(2) = 2 부터 시작해 " +
              "각 항을 앞 두 항의 합으로 채워 내려간다.",
        formula:
          "f(1)  = 1\n" +
          "f(2)  = 2\n" +
          "f(3)  = f(2) + f(1)  = 2 + 1  =  3\n" +
